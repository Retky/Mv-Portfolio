...
const projectOne = new ProjectBox('Courses Webpage Template', ['HTML', 'SCSS', 'JavaScript'], 'img/projects/project01.gif', `This project is an example of a basic a website template for courses, conference & live videos; for mobile and desktop version. <br> In this template there is a landing page, that contains a welcome section, a section for showing the highlight content of the page with a link for join; a section containing information about some of the presenters, teachers or speakers, a section for the partners or sponsors and a footer for containing information about the owner of the website. <br> Original design idea by Cindy Shin in Behance.`, 'See Live', 'https://retky.github.io/CreativeCourses-Page/index.html', 'img/LiveIco.png', 'See Source', 'https://github.com/Retky/CreativeCourses-Page', 'img/SrcIco.png');
